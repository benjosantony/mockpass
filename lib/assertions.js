...
const hashToken = (token) => {
  const fullHash = crypto.createHash('sha512') // change to match sign alg es512 (https://pyjwt.readthedocs.io/en/latest/algorithms.html), https://openid.net/specs/openid-connect-core-1_0.html#CodeIDToken
